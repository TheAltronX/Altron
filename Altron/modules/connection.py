...
from Altron import dispatcher, DRAGONS, DEV_USERS
...
def connection_chat(update, context):
    ...
    if conn:
        message = "You are currently connected to {}.".format(chat_name)
    else:
...
CONN_HELP = """
𝗔𝗰𝘁𝗶𝗼𝗻𝘀 𝗮𝗿𝗲 𝗮𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝘄𝗶𝘁𝗵 𝗰𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 𝗴𝗿𝗼𝘂𝗽𝘀:
 • ᴠɪᴇᴡ ᴀɴᴅ ᴇᴅɪᴛ ɴᴏᴛᴇꜱ.
 • ᴠɪᴇᴡ ᴀɴᴅ ᴇᴅɪᴛ ꜰɪʟᴛᴇʀꜱ.
 • ɢᴇᴛ ɪɴᴠɪᴛᴇ ʟɪɴᴋ ᴏꜰ ᴄʜᴀᴛ.
 • ꜱᴇᴛ ᴀɴᴅ ᴄᴏɴᴛʀᴏʟ ᴀɴᴛɪꜰʟᴏᴏᴅ ꜱᴇᴛᴛɪɴɢꜱ.
 • ꜱᴇᴛ ᴀɴᴅ ᴄᴏɴᴛʀᴏʟ ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴇᴛᴛɪɴɢꜱ.
 • ꜱᴇᴛ ʟᴏᴄᴋꜱ ᴀɴᴅ ᴜɴʟᴏᴄᴋꜱ ɪɴ ᴄʜᴀᴛ.
 • ᴇɴᴀʙʟᴇ ᴀɴᴅ ᴅɪꜱᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ɪɴ ᴄʜᴀᴛ."""
...
command_list = ['connect', 'connection', 'disconnect', 'helpconnect', 'allowconnect']
