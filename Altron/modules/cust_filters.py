...
from Altron import dispatcher, LOGGER, DRAGONS
...
𝗡𝗼𝘁𝗲: ᴀʟʟ ꜰɪʟᴛᴇʀ ᴋᴇʏᴡᴏʀᴅꜱ ᴀʀᴇ ɪɴ ʟᴏᴡᴇʀᴄᴀꜱᴇ. ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ʏᴏᴜʀ ᴋᴇʏᴡᴏʀᴅ ᴛᴏ ʙᴇ ᴀ ꜱᴇɴᴛᴇɴᴄᴇ, ᴜꜱᴇ Qᴜᴏᴛᴇꜱ.
eg: /filter "hey there" How you doin?
...
𝗡𝗼𝘁𝗲: ꜰɪʟᴛᴇʀꜱ ᴀʟꜱᴏ ꜱᴜᴘᴘᴏʀᴛ ᴍᴀʀᴋᴅᴏᴡɴ ꜰᴏʀᴍᴀᴛᴛᴇʀꜱ ʟɪᴋᴇ: {first}, {last} ᴇᴛᴄ.. ᴀɴᴅ ʙᴜᴛᴛᴏɴꜱ.
...
command_list = ['filter', 'stop', 'removeallfilters', 'filters']
