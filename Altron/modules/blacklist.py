...
import Altron.modules.sql.blacklist_sql as sql
from Altron import dispatcher, LOGGER
...
𝗡𝗼𝘁𝗲: ʙʟᴀᴄᴋʟɪꜱᴛꜱ ᴅᴏ ɴᴏᴛ ᴀꜰꜰᴇᴄᴛ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴꜱ.
"""
...
command_list = ['blacklist', 'addblacklist', 'unblacklist', 'blacklistmode']
