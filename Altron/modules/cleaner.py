...
from Altron import CustomCommandHandler, dispatcher
...
from Altron.modules.sql import cleaner_sql as sql
...
𝗙𝗼𝗹𝗹𝗼𝘄𝗶𝗻𝗴 𝗮𝗿𝗲 𝗗𝗶𝘀𝗮𝘀𝘁𝗲𝗿𝘀 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀, 𝗔𝗱𝗺𝗶𝗻𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝘂𝘀𝗲 𝘁𝗵𝗲𝘀𝗲:
  ➲ /gignoreblue <word>: ɢʟᴏʙᴀʟʟʏ ɪɢɴᴏʀᴇᴀ ʙʟᴜᴇᴛᴇxᴛ ᴄʟᴇᴀɴɪɴɢ ᴏꜰ ꜱᴀᴠᴇᴅ ᴡᴏʀᴅ ᴀᴄʀᴏꜱꜱ ꜱᴀɪᴛᴀᴍᴀ.
